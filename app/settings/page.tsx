              ...
              <CardContent className="p-2">
                ...
                >
                  <TabsList className="flex flex-col h-auto bg-transparent space-y-1">
                    <TabsTrigger
                      value="appearance"
                      className="w-full justify-start gap-3 p-3 data-[state=active]:bg-primary/10"
                    >
                    ...
                    <div className="space-y-5">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-2">
                          We recommend using a strong, unique password that you
                          don't use elsewhere.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between p-3 rounded-md border hover:bg-muted/20 transition-colors">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Receive a weekly summary of your journal entries and
                            mood trends.
                          </p>
                        </div>
                        <Switch
                    ...
                    {!pushNotifications && (
                      <div className="mt-3 p-3 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-md flex items-start gap-2">
                        ...
                        <p className="text-sm text-amber-700 dark:text-amber-400">
                          Push notifications are currently disabled. Enable them
                          to receive timely reminders.
                        </p>
                      </div>
                    )}
                  </div>
                ...
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription>
                        Manage your application security and current session.
                      </CardDescription>
                    </div>
                  </div>
                </CardHeader>
